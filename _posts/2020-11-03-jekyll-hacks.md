...
To tie it back to relevancy, I am probably going to use a variant of this theme for my Beeminder blog [beejournal.netlify.app](https://beejournal.netlify.app). Speaking of, I've been thinking more down-the-line about this experiment, and trying to figure out if there would be any meaningful way to measure difference from the beginning to, say, a year after. I can offer my own layman's observations, but it'd be neat to be an academic guinea pig. 
