...
**Week Eleven!** Man, I've been busy this week. Not entirely related to Beeminder, but using beejournal.netlify.app as inspiration, I've decided to migrate my blog from WordPress to Jekyll and upload the source code to my GitHub repository [here](https://github.com/brennanbrown/blog), with the name [notebook.casa](https://notebook.casa)! 
